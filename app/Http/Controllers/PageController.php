        ...
        return [
            [
                ...
                'detail' => [
                    ...
                    'Tersedia 6 template pilihan dengan desain responsif yang bisa diakses dari mana saja. Cocok untuk acara pernikahan, lamaran, akad, atau resepsi.',
                    'Fitur yang tersedia: countdown acara, galeri foto, ucapan & doa dari tamu, lokasi Google Maps, dan tombol bagikan ke WhatsApp.',
                ],
            ],
            [
                'icon' => '📘',
                ...
                'description' => 'Paket latihan soal TWK, TIU, dan TKP dengan sistem skor dinamis, timer, dan pembahasan lengkap.',
                'features' => [
                    'Soal TWK, TIU, TKP lengkap',
                    'Mode latihan & test dengan timer',
                    'Pembahasan detail setiap soal',
                ],
                'price' => 'Mulai Gratis',
                'button' => 'Lihat Soal',
                'button_detail' => 'Mulai Quiz',
                'contact_url' => '/soal',
                'detail' => [
                    'Soal latihan ujian Rangkita menyediakan paket soal TWK, TIU, dan TKP yang bisa dikerjakan secara online.',
                    'Tersedia mode latihan (tanpa batas waktu) dan mode test (dengan timer). Sistem skor dinamis mendukung poin per soal dengan penalty untuk jawaban kosong.',
                    'Setelah selesai mengerjakan, pengguna bisa melihat pembahasan lengkap dan riwayat percobaan sebelumnya.',
                ],
            ],
            [
                'icon' => '⚡',
                ...
                'button_detail' => 'Pesan via WhatsApp',
                'contact_url' => 'https://wa.me/' . config('services.whatsapp.number') . '?text=Halo%20Rangkita,%20saya%20mau%20tanya%20produk%20digital',
                'detail' => [
                    ...
                    'Pembayaran bisa lewat WhatsApp. File dikirim langsung setelah pembayaran terkonfirmasi.',
                ],
            ],
            [
                'icon' => '📝',
                ...
                'title' => 'Artikel & Tips',
                'description' => 'Artikel informatif seputar undangan digital, tips belajar, produk digital, dan panduan kebutuhan digital.',
                'features' => [
                    'Tips undangan & persiapan nikahan',
                    'Panduan belajar CPNS & seleksi',
                    'Review produk digital & tutorial',
                ],
                'price' => 'Gratis Dibaca',
                'button' => 'Baca Artikel',
                'button_detail' => 'Lihat Semua Artikel',
                'contact_url' => '/artikel',
                'detail' => [
                    'Artikel Rangkita berisi tips, panduan, dan informasi bermanfaat seputar undangan digital, belajar ujian, dan produk digital.',
                    'Kontennya dirancang untuk menjawab kebutuhan pengguna sekaligus membantu Rangkita ditemukan lewat pencarian Google.',
                    'Dari artikel, pengguna bisa diarahkan ke produk yang relevan. Artikel bukan cuma bacaan, tapi juga pintu masuk ke ekosistem Rangkita.',
                ],
            ],
        ];
    }
